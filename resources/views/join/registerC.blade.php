    ...
    <div class="row" id="registerS">
        <div class="col-md-3 d-none d-md-block">
            <div class="align-center">
                <div id ="circle"></div>
                <img src="{{asset('front/img/man.png')}}">
            </div>
        </div>
        <div class="col-sm-12 col-md-6">
            <form class="align-center" id="reg-form">
                <h4 class="title-small">Register as a company</h4>
                <input type="text" class="form-control mt-4" placeholder="Your company name*" name="name" id="name" required>
                <input type="email" class="form-control mt-4" placeholder="Your company email*" name="email" id="email" required>
                <button class="btn btn-block back-blue mt-4 font-weight-bold">Request access</button>
                <a href="/noauth" class="btn btn-block border-blue mt-3 mb-4 font-weight-bold">Go back</a>
            </form>
        </div>
    </div>
        ...
        if ($("#reg-form")[0].checkValidity() === false) {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    message: "Company Request Access",
                },
