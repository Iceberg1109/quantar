                ...
                <div class="col-md-8">
                    ...
                    {{-- <div class="panel"> --}}
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                <label for="psw">{{ __('Company password access') }}</label>
                                <input type="text" class="form-control" id="psw" name="psw" placeholder="{{ __('voyager::generic.name') }}"
                                       value="@if(isset($dataTypeContent->psw)){{ $dataTypeContent->psw }}@else {{str_random(8)}} @endif">
                            </div>
